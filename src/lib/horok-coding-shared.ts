...
export type HorokCodingCondition = {
  text: string;
...
export const HOROK_CODING_LEVELS = [
  "Lv.0",
  "Lv.1",
  "Lv.2",
  "Lv.3",
...
export function getHorokCodingChatThreadTitle(problem: HorokCodingProblem) {
  return `${problem.number}번 ${problem.title}`;
}

export function getHorokCodingChatIntroMessage(problem: HorokCodingProblem) {
