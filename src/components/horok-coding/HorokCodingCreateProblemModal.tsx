...
type HorokCodingCreateProblemModalProps = {
  className?: string;
};
...
export default function HorokCodingCreateProblemModal({
  className,
}: HorokCodingCreateProblemModalProps) {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("/api/horok-coding/problems", {
        method: "POST",
        headers: {
