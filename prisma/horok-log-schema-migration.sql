-- Move horok-log domain tables from public to horok_log.
...
CREATE SCHEMA IF NOT EXISTS horok_log;

ALTER TABLE IF EXISTS public.categories SET SCHEMA horok_log;
ALTER TABLE IF EXISTS public.posts SET SCHEMA horok_log;
ALTER TABLE IF EXISTS public.comments SET SCHEMA horok_log;
ALTER TABLE IF EXISTS public.post_likes SET SCHEMA horok_log;
ALTER TABLE IF EXISTS public.post_views SET SCHEMA horok_log;
ALTER TABLE IF EXISTS public.stop_words SET SCHEMA horok_log;

COMMIT;

ALTER TABLE IF EXISTS horok_log.comments
